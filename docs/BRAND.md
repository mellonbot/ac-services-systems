...
| E-17 | OPEN | badgeSvg() names a font family. A favicon is fetched before any stylesheet, so on a machine without the face the mark silently becomes a different mark. |
