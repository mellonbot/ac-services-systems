...
| S2 | Service Manager | OFC | 1 | `console` | role-based, org-wide | `account`, `contract`, `invoice`, `warranty_case`, `part`, `purchase_order`, `subcontractor_firm`, `crew`, `crew_credential`, `rate_card`, `brand_theme`, `job`, `device`, `device_grant` |
